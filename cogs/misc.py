...
class Misc(commands.Cog):
	...
	async def invite(self, ctx):
		"""My invite link"""
		await ctx.send("Pour inviter **EnderBot** dans votre serveur, utilisez le lien suivant : https://discordapp.com/oauth2/authorize?client_id=730154635301617706&scope=bot&permissions=8")
